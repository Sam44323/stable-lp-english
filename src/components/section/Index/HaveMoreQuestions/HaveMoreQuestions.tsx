...
const HaveMoreQuestions = () => {
  return (
    <div className="gradient-blue-bg 2xl:max-w-screen-2xl max-w-screen-xl mx-auto rounded-3xl md:min-h-[250px]   relative mt-36 overflow-clip">
      <div>
        <img
      ...
      <div className="absolute flex flex-row items-start justify-between w-full z-10 max-w-screen-lg mx-auto  left-16 top-7 pt-16">
        <div>
