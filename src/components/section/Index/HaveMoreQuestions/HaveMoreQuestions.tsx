...
const HaveMoreQuestions = () => {
  return (
    <div className="gradient-blue-bg 2xl:max-w-screen-2xl max-w-[1200px] mx-auto rounded-3xl md:min-h-[250px]   relative overflow-clip mobile:max-w-[1200px] mobile:mx-auto mobile:pb-10">
      <div>
        <img
