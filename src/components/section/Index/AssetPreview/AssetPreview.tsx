...
const AssetPreview = () => {
  // pb-[400px]
  return (
    <div className="bg-[url('/images/gradients/gradient-bent.svg')] bg-[center_top_5rem] pb-48 bg-no-repeat bg-cover 2xl:bg-cover large-screen:bg-cover mobile:bg-cover mt-10 relative z-30 mobile:mt-16">
      ...
      <section className="mt-36 flex justify-between align-middle max-w-[1300px] mx-auto mobile:flex-col mobile:items-center mobile:mt-16">
        <div className="flex flex-col items-center justify-between text-center">
          <h1 className="text-center text-xl text-blue-text font-500 font-roboto max-w-[86%] mx-auto mb-10">
        ...
        <div className="flex flex-col items-center text-center justify-between">
          <h1 className="text-center text-xl text-blue-text font-500 font-roboto max-w-[60%] mx-auto mb-10">
        ...
        <div className="flex flex-col items-center justify-between text-center">
          <h1 className="text-center text-xl text-blue-text font-500 font-roboto max-w-[70%] mx-auto mb-10">
