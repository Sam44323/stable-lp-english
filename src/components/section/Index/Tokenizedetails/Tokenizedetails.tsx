...
const Tokenizedetails = () => {
  return (
    <>
      <div className="relative large-screen:static mb-16 lg:mb-48">
        <div className="max-w-[160rem] large-screen:relative mx-auto">
          <div className="max-w-[800px] mx-auto -translate-x-16 mt-16 mobile:max-w-[80%] mobile:translate-x-0 mobile:flex mobile:flex-col mobile:items-center mobile:mt-5">
            ...
            <div className="flex flex-row-reverse justify-between items-center mobile:flex-col mobile:hidden">
              ...
              <p className="flex-[0.85] text-grey-100 text-[17px] text-md font-300 leading-6 text-right font-work-sans mobile:text-center">
                ...
                of whether they use Avalanche, Polygon, Arbitrum, or any other
                EVM chain. <br /> <br />{" "}
            ...
            <div className="hidden mobile:flex mobile:flex-col mobile:text-center">
              ...
              <p className="flex-[0.85] text-grey-100 text-md font-300 leading-6 text-right font-work-sans mobile:text-center">
                Stable’s platform, tokens, and smart contracts were
                intentionally designed to be multi-chain, allowing for
                effortless adoption and integration. We are committed to
                deploying on all EVM-compatible chains over time, enabling Defi
                and non-Defi users to bring their preferred currencies and
                assets from traditional financial markets to the blockchain of
                their choice, regardless of whether they are using Avalanche,
                Polygon, Arbitrum, or any other EVM chain. Our vision has always
                been to be multi-chain right from the start!
              </p>
            </div>
          </div>
          <img
            src="/images/shapes/ellipse-with-masks.png"
            className="absolute -right-0 -translate-y-[840px] -z-10 mid-screen:hidden mobile:hidden large-screen:hidden"
          />
          <img
            src="/images/shapes/full-ellipse-with-masks.png"
            className="absolute -right-0 -translate-y-[840px] -z-10 mid-screen:hidden hidden large-screen:block"
          />
        </div>
      </div>
      <Supportedchains />
