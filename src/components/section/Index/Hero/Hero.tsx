    ...
    <div className="max-w-5xl relative flex flex-row justify-evenly ml-auto mr-auto mt-48">
      <section>
        <div className="relative mobile:flex mobile:flex-col mobile:w-full mobile:items-center">
          ...
          />
          <h1 className="text-link-inactive tracking-tighter text-6xl font-500 font-roboto leading-[1.4] m-0 mobile:text-4xl mobile:text-center">
        ...
        <div className="relative">
          ...
          />
          <p className="font-manrope font-300 w-78 mt-4 leading-[1.6] tracking-wide ml-[7px] mobile:ml-0 mobile:text-center">
