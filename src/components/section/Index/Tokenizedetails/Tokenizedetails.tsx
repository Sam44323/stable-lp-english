  ...
  return (
    <>
      <div className="relative">
        <div className="max-w-[850px] mx-auto mt-16 mobile:max-w-[80%] mobile:translate-x-0 mobile:flex mobile:flex-col mobile:items-center mobile:mt-5 ">
          ...
          <div className="flex flex-row-reverse justify-between items-center">
            ...
            <p className="flex-[0.85] text-grey-100 text-md font-300 leading-6 text-right font-work-sans">
        ...
        <img
          ...
          className="absolute -right-10 -translate-y-[950px] -z-10 mobile:hidden"
        />
      </div>
      <Supportedchains />
    </>
