  ...
  return (
    <div className="bg-[url('/images/gradients/gradient-bent.svg')] bg-[center_top_5rem] pb-[140px] mt-80 mobile:pb-[30px] bg-no-repeat bg-cover 2xl:bg-cover large-screen:bg-cover mobile:bg-cover relative z-30 mobile:mt-16">
      <img
        ...
        className="max-w-screen-lg mx-auto mt-16 mobile:hidden -translate-y-48"
        height={800}
        width={1200}
        alt="redeem-flow"
      />
      <img
        ...
        alt="redeem-flow"
      />
      <section className="max-w-[1300px] mx-auto -mt-16">
        <div className="flex flex-col items-center">
          <h1 className="text-5xl font-500 mb-3 text-blue-text mobile:text-[30px] font-roboto">
            How to acquire our Real-World Assets?
          </h1>
          <p className="font-manrope text-grey-100 text-lg font-600 tracking-wide">
